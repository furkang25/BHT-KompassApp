...
public class ScheduleWednesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schedule_wednesday);
    ...
    private void startScheduleAlert (String alert, String message, int scheduleNumber) {
        AlertDialog alertDialog = new AlertDialog.Builder(ScheduleWednesdayActivity.this).create();
    ...
    public void deleteSchedule (int scheduleNumber) throws ParseException {
        switch (scheduleNumber) {
            case 1:
                deleteScheduleDatabase("Mittwoch", "8:00 - 9:30", ParseUser.getCurrentUser().getUsername());
                break;
            case 2:
                deleteScheduleDatabase("Mittwoch", "10:00 - 11:30", ParseUser.getCurrentUser().getUsername());
                break;
            case 3:
                deleteScheduleDatabase("Mittwoch", "12:15 - 13:45", ParseUser.getCurrentUser().getUsername());
                break;
            case 4:
                deleteScheduleDatabase("Mittwoch", "14:15 - 15:45", ParseUser.getCurrentUser().getUsername());
                break;
            case 5:
                deleteScheduleDatabase("Mittwoch", "16:00 - 17:30", ParseUser.getCurrentUser().getUsername());
                break;
            case 6:
                deleteScheduleDatabase("Mittwoch", "17:45 - 19:15", ParseUser.getCurrentUser().getUsername());
                break;
            case 7:
                deleteScheduleDatabase("Mittwoch", "19:30 - 21:00", ParseUser.getCurrentUser().getUsername());
                break;
        }
    }
    ...
    private void chooseAddOption() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ScheduleWednesdayActivity.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        ...
        if (requestCode == CHOOSE_PDF_FROM_DEVICE && resultCode == Activity.RESULT_OK) {
            ...
            if (resultData != null) {
                ...
                try {
                    InputStream inputStream = ScheduleWednesdayActivity.this.getContentResolver().openInputStream(selectedPdfFromStorage);
    ...
    public void createObject(String module, String prof, String room, String time) {
        ...
        entity.put("day", "Mittwoch");
        entity.put("time", time);
        entity.put("room", room);
        entity.put("module", module);
        entity.put("dayTimeUser", "Mittwoch" + time + currentUser.getUsername());
    ...
    public void loadData () {
        ...
        query.whereEqualTo("day", "Mittwoch");
        query.findInBackground((objects, e) -> {
            if (e == null) {
                for (int i = 0; i < objects.size(); i++) {
